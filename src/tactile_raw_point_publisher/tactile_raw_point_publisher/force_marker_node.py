...
class TactileForceMarkerNode(Node):
    ...
    def __init__(self) -> None:
        ...
        self.declare_parameter('base_point_scale', 0.01)
        self.declare_parameter('vector_scale', 0.002)
        self.declare_parameter('max_magnitude', 255.0)
        self.declare_parameter('shaft_diameter', 0.005)
        self.declare_parameter('head_diameter', 0.008)
        self.declare_parameter('head_length', 0.008)
